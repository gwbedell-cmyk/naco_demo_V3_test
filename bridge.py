...
class MGEPlusBridge:
    def __init__(self):
        ...
        self.lambda_p = 0.18   # slightly stronger passion
    ...
    def compute_dual_coherence(self, founder_text, investor_text):
        ...
        coherence = 1.0 / (1.0 + xi * 0.75)   # tuned scaling
        score = int(round(100 * coherence))
        return {"score": score, "s_f": s_f, "s_i": s_i}
    ...
    def compute_gap(self, founder_text, investor_text, s_f, s_i):
        ...
        gap_map = {
            0: "The founder shows stronger relational trust than the investor currently feels comfortable extending.",
            1: "The founder emphasizes broader societal impact more than the investor currently prioritizes.",
            2: "The founder’s strategic thinking appears more developed than the investor’s current lens.",
            3: "The founder is moving faster than the investor is comfortable with."
        }
    ...
    def compute_improved_score(self, s_f, s_i, gap_idx):
        ...
        coherence_new = 1.0 / (1.0 + xi_new * 0.68)
